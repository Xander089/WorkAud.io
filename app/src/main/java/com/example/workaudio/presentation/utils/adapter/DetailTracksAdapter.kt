...
import com.example.workaudio.presentation.utils.itemTouchHelper.ItemTouchHelperAdapter
import java.util.*
...
) : RecyclerView.Adapter<DetailTracksAdapter.TrackListViewHolder>(), ItemTouchHelperAdapter, BaseAdapter {
